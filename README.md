...
- [ ] VSCode 拡張として、[設定](./helmingway.config.yaml)に基づいて Helm チャートの alias ごとのレンダリング結果をプレビューできる
...
- [x] Step 3: [設定](./helmingway.config.yaml) を読み込んで chart / alias を表示する
- [ ] Step 4: alias をクリックしたら仮のプレビューを開く
